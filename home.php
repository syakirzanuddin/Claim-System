...
<main>
    <div class="container text-center">
		...
		<div class="page-header clearfix">
			<h4 class="pull-left">Maklumat Pelajar UPTA</h4>
		</div>
<?php
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "
		<table class='table table-borderless' align='center' cellpadding = '5' style='width:90%;'>
...
?>
<br><br>
<a href="formstudent.php" class="btn btn-success pull-right">Kemaskini Penyata Tuntutan</a>
<br><br>
<a href="indexAtt.php" class="btn btn-success pull-right">Kemaskini Kehadiran Pelajar</a>
	<br><br>	
</div></main><br>
